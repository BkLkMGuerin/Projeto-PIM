...
def cadastro(CAMINHO_ARQUIVO):
  ...
  cadastro_aluno = (nome_aluno + ',' + ra_aluno + ',' + turma_aluno) #Esta é a linha que será guardada todas as informações juntas do cadastro do aluno no arquivo da matéria
  notas_aluno = float(input('Qual a np1 do aluno: \n'))
  notas_aluno2 = float(input('Qual a np2 do aluno: \n'))
  media_final = (notas_aluno + notas_aluno2 / 2)
